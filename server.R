shinyServer(function(input, output) {
 ...
 output$resultado2b<- renderPrint({
   a2b<-input$casoexp2
 ...
 output$resultado3b<- renderPrint({
   a<-input$casoexp2b
   b<-input$nocasoexp2b
   c<-input$casonoexpb
 ...
 output$resultado3c<- renderPrint({
   a<-input$casoexp3b
   b<-input$nocasoexp3b
   c<-input$casonoexpb
   d<-input$nocasonoexpb
 ...
 output$resultado4a<- renderPrint({
   a<-input$casoexp2c
   b<-input$nocasoexp2c
   c<-input$casonoexpc
   d<-input$nocasonoexpc
 ...
 output$resultado4b<- renderPrint({
   a<-input$casoexp3c
   b<-input$nocasoexp3c
   c<-input$casonoexpc
   d<-input$nocasonoexpc
 ...
 output$resultado4c<- renderPrint({
   a<-input$casoexp4c
   b<-input$nocasoexp4c
   c<-input$casonoexpc
   d<-input$nocasonoexpc
